            ...
            with thoughts_placeholder:
                ...
                if 'output_placeholder' in locals():
                    ...
                    if isinstance(output_data, str):
                        # Directly display the string if it's plain text
                        output_placeholder.code(output_data)
                    elif hasattr(output_data, 'content'):
                        # Display the `content` attribute if it exists
                        output_placeholder.code(output_data.content)
                    else:
                        # Handle unexpected cases
                        output_placeholder.write("Unexpected output format:")
                        output_placeholder.code(output_data)
